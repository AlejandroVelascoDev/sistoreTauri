  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400">{t("Gestiona tus productos y stock")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-slate-700/50 shadow-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-gray-400 text-sm">{t("Total Productos")}</p>
        ...
        <div className="bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-slate-700/50 shadow-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-gray-400 text-sm">{t("Valor Inventario")}</p>
        ...
        <div className="bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-slate-700/50 shadow-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-gray-400 text-sm">{t("Stock Bajo")}</p>
      ...
      <div className="bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-slate-700/50 shadow-xl mb-6">
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          <div className="relative flex-1 w-full md:w-auto">
            ...
            <input
              type="text"
              placeholder={t("Buscar por nombre o categoría...")}
              value={searchTerm}
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-400 text-lg">
                {searchTerm
                  ...
                  : t("No hay productos en el inventario")}
              </p>
              {!searchTerm && (
                <button
                  onClick={() => openModal()}
          ...
          <div className="bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl border border-slate-700/50 w-full max-w-md shadow-2xl">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  type="text"
                  placeholder={t("Ej: Coca-cola 500 ml")}
              ...
              <div>
                ...
                >
                  <option value="General">{t("Bebidas")}</option>
                  <option value="Electrónica">{t("Empaquetados")}</option>
                  <option value="Accesorios">{t("Refrigerados")}</option>
                </select>
              </div>
              ...
              <div className="flex gap-3 pt-4">
                ...
                >
                  {editingProduct ? t("Actualizar") : t("Crear")}
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl border border-slate-700/50 w-full max-w-md shadow-2xl p-6">
            ...
            <p className="text-gray-400 text-center mb-6">
              {t("Esta acción no se puede deshacer. El producto será eliminado permanentemente del inventario.")}
            </p>
